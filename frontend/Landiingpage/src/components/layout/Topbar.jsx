        ...
        <div className="topbar-notification-wrapper">
          ...
          {showNotifications && (
            <div className="topbar-notif-dropdown">
              ...
              <div className="notif-footer" style={{ padding: '0.75rem', textAlign: 'center', borderTop: '1px solid rgba(255, 85, 0, 0.1)' }}>
                <Link to="/notifications" onClick={() => setShowNotifications(false)} style={{ color: 'var(--accent-orange)', fontSize: '0.8rem', fontWeight: 600, textDecoration: 'none', letterSpacing: '0.05em' }}>
