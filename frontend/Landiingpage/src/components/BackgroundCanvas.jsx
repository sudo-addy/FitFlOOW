...
export default function BackgroundCanvas() {
  ...
  useEffect(() => {
    ...
    renderer.setSize(canvas.parentElement ? canvas.parentElement.offsetWidth : window.innerWidth, canvas.parentElement ? canvas.parentElement.offsetHeight : window.innerHeight);
