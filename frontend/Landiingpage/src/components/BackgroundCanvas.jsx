...
export default function BackgroundCanvas() {
  ...
  useEffect(() => {
    ...
    const init2D = (canvasElement) => {
      ...
      class Particle {
        ...
        draw() {
          ...
          // Draw outer glow circle (fast nested draw instead of expensive CPU shadowBlur)
          ctx.beginPath();
    ...
    // Helper to check WebGL capability before making THREE calls
    ...
    // Run WebGL with graceful fallback to 2D Canvas without context collisions
    if (checkWebGLSupport()) {
      ...
      console.log("WebGL is not supported or is disabled. Falling back to high-performance 2D Canvas particles.");
      cleanupFn = init2D(canvas);
    }
